...
class _HistoryScreenState extends ConsumerState<HistoryScreen> {
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return FadeInUp(
                            ...
                            child: _buildHistoryCard(history, isDark),
                          );
                        },
                      ),
                    ),
  ...
  Widget _buildHistoryCard(ScanHistory history, bool isDark) {
      ...
      child: Container(
        ...
        child: Material(
          ...
          child: InkWell(
            borderRadius: BorderRadius.circular(16),
            onTap: () {
              _showHistoryDetails(history, isDark);
            },
            child: Padding(
              padding: const EdgeInsets.all(16),
              child: Column(
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: (isSpam ? AppColors.danger : AppColors.success).withOpacity(isDark ? 0.2 : 0.1),
  ...
  void _showHistoryDetails(ScanHistory history, bool isDark) {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Icon(Icons.access_time, size: 16, color: isDark ? AppColors.darkTextSecondary : AppColors.textSecondary),
